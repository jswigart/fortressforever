...
#define SG_EXPLOSIONDAMAGE_ENABLED true //ffdev_sg_explosiondamage_enabled.GetBool()
...
#define SG_EXPLOSIONDAMAGE_BASE 51.0f //sg_explosiondamage_base.GetFloat() // 51.0f 
//ConVar ffdev_sg_explosionradius("ffdev_sg_explosionradius", "128.0", FCVAR_FF_FFDEV_REPLICATED, "SG explosion radius");
#define SG_EXPLOSIONRADIUS 128.0f //ffdev_sg_explosionradius.GetFloat()
...
#define SG_RETURNTOIDLETIME 1.0f //sg_returntoidletime.GetFloat() // 1.0f
...
#define SG_TURNSPEED_AFTERLOCK 0.1f //sg_returntoidlespeed.GetFloat() // 0.1f

//ConVar sg_empdmg_base("ffdev_sg_empdmg_base", "100", FCVAR_FF_FFDEV_REPLICATED, "Base damage a sentry takes from an emp.");
#define SG_EMPDMG_BASE 100.f //sg_empdmg_base.GetFloat() // 100.0f
...
#define SG_EMPDMG_SHELLS_MULTI 0.5f //sg_empdmg_shells_multi.GetFloat() // 0.5f
...
#define SG_EMPDMG_ROCKETS_MULTI 0.9f //sg_empdmg_rockets_multi.GetFloat() // 0.9f
...
#define SG_ACKNOWLEDGE_SABOTAGE_DELAY 2.5f //sg_acknowledge_sabotage_delay.GetFloat() // 2.5f
...
#define SG_ANGULAR_ACCEL_YAW 0.75f //sg_accel_yaw.GetFloat() // 0.75f
//ConVar sg_accel_pitch("ffdev_sg_accel_pitch", "1.5", FCVAR_FF_FFDEV_REPLICATED, "Maximum angular acceleration of SG in pitch");
#define SG_ANGULAR_ACCEL_PITCH 1.5f //sg_accel_pitch.GetFloat() // 1.5f
...
#define SG_ACCELDISTANCEMULT 0.008f //sg_accel_distmult.GetFloat() // 0.008f
